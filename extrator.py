...
# Mostranto o Tamanho da Url
print("O tamanho da URL é ", len(extrator_url))

# Mostranto o Valor quantidade colocado na URL
valor_quantidade = extrator_url.get_valor_parametro("quantidade")
print(valor_quantidade)

# Utilizando e testando a Função STR do Codigo
print(extrator_url)

# Utilizando e Testando funçao de comparação
print(extrator_url == extrator_url)